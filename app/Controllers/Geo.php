...
class Geo extends BaseController
{
    ...
    public function nyc()
    {
        return $this->cityPage('New York', 'NYC', 'georgian-restaurant-nyc');
    }

    // Georgian Restaurant New York - 4.4K поисков  
    public function newYork()
    {
        return $this->cityPage('New York', 'New York', 'georgian-restaurant-new-york');
    }

    // Georgian Restaurant Chicago - 590 поисков
    public function chicago()
    {
        return $this->cityPage('Chicago', 'Chicago', 'georgian-restaurant-chicago');
    }

    // Georgian Restaurant Manhattan - 590 поисков
    public function manhattan()
    {
        return $this->cityPage('Manhattan', 'Manhattan', 'georgian-restaurant-manhattan');
    }
